...
final_join %>% group_by(country) %>% na.omit() %>% summarize(mean_malaria=mean(malaria)) %>% arrange(desc(mean_malaria)) %>% kable(align = 'l', digits = 3) %>% kable_styling(font_size = 15)
